...
<body onload="examTimer()">
	...
	<div class="navbar navbar-inverse set-radius-zero">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand imgr" href="index.jsp"> <img
					src="images/tcsionl.PNG" style="width: 200px; height: 70px;" />
				</a>
			</div>
	...
	<jsp:include page="StudentSideHeaderexam.jsp"></jsp:include>
	...
	<section class="footer-section">
		<div class="container">
			<div class="row">
				<div class="col-md-12">&copy;2021 TCS-iON.com </div>
